/**
 * Social media icon set for public site links. Each icon is 24x24 inline SVG.
 */
...
export function SocialIconLink({ link }: { link: SocialLinkItem }) {
  return (
    <a
      href={link.url}
      target="_blank"
    ...
    >
      <SocialIcon kind={link.kind} className="h-6 w-6" />
    </a>
  );
}

export function SocialLinksSection({ links }: { links: SocialLinkItem[] }) {
